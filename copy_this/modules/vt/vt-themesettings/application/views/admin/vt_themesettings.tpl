    ...
    <tr>
        [{if isset($parent_grouping) && isset($oParentTheme) }]
            <td valign="top">
                <form name="myedit" id="parentedit" action="[{ $oViewConf->getSelfLink() }]" method="post">
                    ...
                    <input type="hidden" name="parenttheme" value="[{$oParentTheme->getInfo('id')}]">
                    <input type="hidden" name="oxid" value="[{$oTheme->getInfo('id')}]">
        ...
        <td valign="top">
            <form name="myedit" id="myedit" action="[{ $oViewConf->getSelfLink() }]" method="post">
                ...
                [{/foreach}]
                <br>
                <input type="submit" class="confinput" name="save" value="[{ oxmultilang ident="GENERAL_SAVE" }]" onClick="Javascript:document.myedit.fnc.value='save'" [{ $readonly }]><br/>
                <input type="submit" class="confinput" name="fnc" value="reloadSettings" onClick="Javascript:document.myedit.fnc.value='reloadSettings'" [{ $readonly }]>
            </form>
