...
runner.exec("git clone git@github.com:vanilla-thunder/vt-themesettings.git _master --depth 1",
...
runner.exec("git clone -b module git@github.com:vanilla-thunder/vt-themesettings.git _module --depth 1",
    function (err, stdout, stderr) {
        if(err) console.log(err);
        else if(stderr) console.log(stderr);
